...
|---|---|---|---|
| UC009.001 | Login | MUST HAVE | 2 |
| UC009.002 | Logout | MUST HAVE | 1 |
| UC009.003 | Get Current User | MUST HAVE | 1 |
...
|---|---|---|
| POST | `/api/v1/auth/login` | UC009.001 |
| POST | `/api/v1/auth/logout` | UC009.002 |
| GET | `/api/v1/auth/me` | UC009.003 |
