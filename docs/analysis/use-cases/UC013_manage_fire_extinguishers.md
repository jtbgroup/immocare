...
- Building exists.
- For US071: the building is open (not deleted).
- For US072, US073: the extinguisher exists.
- For US075, US076, US077: the extinguisher exists.

---

## Main Flows

### Add Fire Extinguisher (US071)
...
### Delete Fire Extinguisher (US073)
...
### View Fire Extinguishers List (US074)
...
|---|---|---|
| GET | `/api/v1/buildings/{buildingId}/fire-extinguishers` | US074 |
| GET | `/api/v1/fire-extinguishers/{id}` | US074 |
| POST | `/api/v1/buildings/{buildingId}/fire-extinguishers` | US071 |
| PUT | `/api/v1/fire-extinguishers/{id}` | US072 |
| DELETE | `/api/v1/fire-extinguishers/{id}` | US073 |
| POST | `/api/v1/fire-extinguishers/{id}/revisions` | US075 |
| DELETE | `/api/v1/fire-extinguishers/{extId}/revisions/{revId}` | US077 |
...
| [UC013](./UC013_manage_fire_extinguishers.md) | Manage Fire Extinguishers | US071–US077 | 📋 Ready for Implementation |
