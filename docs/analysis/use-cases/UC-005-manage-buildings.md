...
**Acceptance Criteria:**
- AC1: All fields from UC005.001 can be updated.
...
7. Controller: `BuildingController` — @RequestMapping("/api/v1/buildings"), all endpoints as per UC005.001–UC005.005b. @PreAuthorize("isAuthenticated()").
