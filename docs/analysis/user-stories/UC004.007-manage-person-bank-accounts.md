# User Story UC004.007: Manage Person Bank Accounts (IBAN)

| Attribute | Value |
|-----------|-------|
| **Story ID** | UC004.007 |
| **Epic** | Person Management |
| **Related UC** | UC007, UC004_ESTATE_PLACEHOLDER |
| **Priority** | MUST HAVE |
| **Story Points** | 3 |
...
**AC7:** During transaction import (UC016), `counterparty_account` is matched case-insensitively against all known IBANs. If a match is found, the system suggests the most suitable lease of the matched person (see UC004_ESTATE_PLACEHOLDER — lease suggestion algorithm).
