# User Story UC016.001: Select Parser on Import
...
**AC1:** Import form (UC015.007) shows a "Parser" dropdown as the first field, listing all active parsers ordered by label. Each entry displays: label, format badge (CSV / PDF), bank hint (e.g. "Keytrade").
