# User Story UC015.011: View Financial Summary and Statistics
...
**AC10:** "Export CSV" button in dashboard header → exports the filtered transaction list (UC015.012) using the same filters currently applied to the dashboard.
