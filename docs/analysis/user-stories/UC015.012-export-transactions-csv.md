# User Story UC015.012: Export Transactions to CSV
...
**AC1:** "Export CSV" button available in two places: the transaction list header (UC015.001) and the dashboard header (UC015.011).
