# User Story UC015.010: Manage Bank Account Catalog
...
**AC10:** On CSV import (UC015.007): if the value parsed from the bank account column exactly matches a known IBAN in the catalog, the account is auto-assigned to the transaction.
