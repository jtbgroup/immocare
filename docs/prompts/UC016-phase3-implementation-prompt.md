# ImmoCare — UC016 Manage Estates — Phase 3 Implementation Prompt

I want to implement UC016 - Manage Estates (Phase 3 of 6) for ImmoCare.
...
```sql
-- Use case: UC016 — Manage Estates (Phase 3)
...
The IBAN lookup for lease suggestion (UC015) must now be scoped:
