# ImmoCare — UC014 Manage Platform Configuration — Implementation Prompt

I want to implement Use Case UC014 - Manage Platform Configuration for ImmoCare.
...
- **Implement this UC before UC014** — boiler alert threshold and validity rules are read from platform_config
...
| UC013.004 | Update General Settings | MUST HAVE | 3 |
...
|--------|------|------|----------|-------|
| GET | `/api/v1/config/settings` | — | `List<PlatformConfigDTO>` 200 | UC013.001, UC013.004 |
| PUT | `/api/v1/config/settings/{key}` | `UpdatePlatformConfigRequest` | `PlatformConfigDTO` 200 | UC013.004 |
| GET | `/api/v1/config/boiler-validity-rules` | — | `List<BoilerServiceValidityRuleDTO>` 200 | UC013.003 |
| POST | `/api/v1/config/boiler-validity-rules` | `AddBoilerServiceValidityRuleRequest` | `BoilerServiceValidityRuleDTO` 201 | UC013.002 |
| GET | `/api/v1/config/asset-type-mappings` | — | `List<AssetTypeMappingDTO>` 200 | UC013.004 |
| PUT | `/api/v1/config/asset-type-mappings/{assetType}` | `UpdateAssetTypeMappingRequest` | `AssetTypeMappingDTO` 200 | UC013.004 |
...
**1. Boiler Service Validity Rules (UC013.002, UC013.003):**
...
**2. General Settings (UC013.004 AC1–AC6):**
...
**3. Asset Type Mappings (UC013.004 AC7–AC13):**
...
- [ ] Mapping saved → pre-fills subcategory when asset link added to transaction (verified via UC015)
- [ ] All UC013.001–UC013.004 acceptance criteria verified
