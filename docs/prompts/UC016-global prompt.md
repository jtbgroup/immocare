# UC016 — Manage Estates — Phase 1 Generation Prompt

## Context

This prompt generates the **Phase 1** implementation of UC016 — Manage Estates for the ImmoCare application.
...
|--------|------|-------------|
| GET | `/` | US095 — list all estates |
| POST | `/` | US092 — create estate |
| PUT | `/{id}` | US093 — edit estate |
| DELETE | `/{id}` | US094 — delete estate |
...
|--------|------|------|-------------|
| GET | `/mine` | any authenticated | US103 — my estates |
| GET | `/{id}/dashboard` | MEMBER | US102 — dashboard |
...
- BR-UC016-09: Cannot delete estate with buildings (buildingCount > 0 → 409)
