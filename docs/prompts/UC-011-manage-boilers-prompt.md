# ImmoCare — UC014 Manage Boilers — Implementation Prompt

I want to implement Use Case UC014 - Manage Boilers for ImmoCare.
...
```java
Optional<BoilerDTO> getActiveBoiler(Long unitId);          // UC011.002
List<BoilerDTO> getAllBoilers(Long unitId);                 // UC011.004
BoilerDTO addBoiler(Long unitId, AddBoilerRequest req, AppUser currentUser);       // UC011.001
BoilerDTO replaceBoiler(Long unitId, ReplaceBoilerRequest req, AppUser currentUser); // UC011.003
List<BoilerServiceRecordDTO> getServiceRecords(Long boilerId);                     // UC011.006
BoilerServiceRecordDTO addServiceRecord(Long boilerId, AddBoilerServiceRecordRequest req, AppUser currentUser); // UC011.005
```
...
|--------|------|------|----------|-------|
| GET | `/api/v1/housing-units/{unitId}/boilers/active` | — | `BoilerDTO` 200 or 204 | UC011.002 |
| GET | `/api/v1/housing-units/{unitId}/boilers` | — | `List<BoilerDTO>` 200 | UC011.004 |
| POST | `/api/v1/housing-units/{unitId}/boilers` | `AddBoilerRequest` | `BoilerDTO` 201 | UC011.001 |
| PUT | `/api/v1/housing-units/{unitId}/boilers/active/replace` | `ReplaceBoilerRequest` | `BoilerDTO` 200 | UC011.003 |
| GET | `/api/v1/boilers/{boilerId}/services` | — | `List<BoilerServiceRecordDTO>` 200 | UC011.006 |
| POST | `/api/v1/boilers/{boilerId}/services` | `AddBoilerServiceRecordRequest` | `BoilerServiceRecordDTO` 201 | UC011.005 |
| GET | `/api/v1/boilers/{boilerId}/transaction-count` | — | `long` 200 | UC015.006 |
...
- [ ] All UC011.001–UC011.007 acceptance criteria verified
