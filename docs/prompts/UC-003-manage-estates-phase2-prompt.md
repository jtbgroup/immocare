# ImmoCare — UC004_ESTATE_PLACEHOLDER Manage Estates — Phase 2 Implementation Prompt

I want to implement UC004_ESTATE_PLACEHOLDER - Manage Estates (Phase 2 of 6) for ImmoCare.
...
```sql
-- Use case: UC004_ESTATE_PLACEHOLDER — Manage Estates (Phase 2)
...
|--------|------|------|-------|
| GET | `/api/v1/estates/{estateId}/buildings` | `isMemberOf` | UC005.004 |
| GET | `/api/v1/estates/{estateId}/buildings/{id}` | `isMemberOf` | UC005.004 |
| GET | `/api/v1/estates/{estateId}/buildings/cities` | `isMemberOf` | UC005.005b |
| POST | `/api/v1/estates/{estateId}/buildings` | `isManagerOf` | UC005.001 |
| PUT | `/api/v1/estates/{estateId}/buildings/{id}` | `isManagerOf` | UC005.002 |
| DELETE | `/api/v1/estates/{estateId}/buildings/{id}` | `isManagerOf` | UC005.003 |
