...
mvn spring-boot:run \
    -DskipTests \
    "-Dspring-boot.run.jvmArguments=-agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=*:5005 -Dserver.port=8081 -Dspring.profiles.active=${ACTIVE_PROFILE}" &
