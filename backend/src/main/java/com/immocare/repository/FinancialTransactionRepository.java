...
public interface FinancialTransactionRepository
         ...
         * null.
         * UC004_ESTATE_PLACEHOLDER Phase 4: check is now estate-scoped to avoid
         * cross-estate dedup conflicts.
         */
         ...
         * A transaction from estate A should not block import of the same transaction
         * in estate B.
         */
        boolean existsByImportFingerprintAndEstateId(String importFingerprint, UUID estateId);

        /**
         * Returns the id of the existing transaction with the given fingerprint within
         * the estate.
         */
