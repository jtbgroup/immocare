...
/**
 * Cross-cutting service that aggregates all application alerts into a unified list.
 *
 * <p>Add new alert sources here as the application grows (PEB expiry, insurance, …).
...
public class AlertService {
    ...
    private AlertDTO fromLease(LeaseAlertDTO src) {
        ...
        return new AlertDTO(
                ...
                isEndNotice
                        ? "End notice — " + src.getBuildingName() + " / unit " + src.getHousingUnitNumber()
                        : "Indexation due — " + src.getBuildingName() + " / unit " + src.getHousingUnitNumber(),
                src.getDeadline(),
    ...
    private AlertDTO fromBoiler(BoilerDTO src) {
        ...
        return new AlertDTO(
                ...
                src.daysUntilNextService() != null
                        ? (overdue
                                ? "Overdue by " + Math.abs(src.daysUntilNextService()) + " day(s)"
