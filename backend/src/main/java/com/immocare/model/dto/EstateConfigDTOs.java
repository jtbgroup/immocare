...
public final class EstateConfigDTOs {
        ...
        public static final List<PlatformConfigSeed> DEFAULT_CONFIG = List.of(
                        ...
                        new PlatformConfigSeed(KEY_ALERT_LEASE_END_NOTICE_DAYS, "30", "INTEGER",
                                        "Days before lease end to display a warning alert"),
                        new PlatformConfigSeed(KEY_ALERT_LEASE_INDEXATION_DAYS, "30", "INTEGER",
