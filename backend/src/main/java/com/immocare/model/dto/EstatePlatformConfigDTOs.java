...
/**
 * DTOs for UC016 Phase 5 — per-estate Platform Configuration and Boiler Validity Rules.
...
public final class EstatePlatformConfigDTOs {
    ...
    public record AddBoilerServiceValidityRuleRequest(
            ...
            @Min(value = 1, message = "Validity duration must be at least 1 month")
            Integer validityDurationMonths,
