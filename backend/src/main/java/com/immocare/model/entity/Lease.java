...
public class Lease {
    ...
    @Column(name = "registration_inventory_spf", length = 50) private String registrationInventorySpf;
    ...
    public HousingUnit getHousingUnit() { return housingUnit; } public void setHousingUnit(HousingUnit v) { this.housingUnit = v; }
    public LeaseStatus getStatus() { return status; } public void setStatus(LeaseStatus v) { this.status = v; }
    ...
    public LeaseType getLeaseType() { return leaseType; } public void setLeaseType(LeaseType v) { this.leaseType = v; }
    ...
    public ChargesType getChargesType() { return chargesType; } public void setChargesType(ChargesType v) { this.chargesType = v; }
    ...
    public DepositType getDepositType() { return depositType; } public void setDepositType(DepositType v) { this.depositType = v; }
    ...
    public List<LeaseTenant> getTenants() { return tenants; } public void setTenants(List<LeaseTenant> v) { this.tenants = v; }
