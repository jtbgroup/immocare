...
- [x] dans le formulaire d'édition de la transaction, les buildings, units et lease doivent être des listes liées entre elles et je ne dois pas introduire des id mais sélectionner les valeurs en language compéhensible. 
