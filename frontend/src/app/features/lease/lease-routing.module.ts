...
@Component({
  ...
  templateUrl: "./components/tenant-section/tenant-section.component.html",
  styleUrls: ["./components/tenant-section/tenant-section.component.scss"],
})
export class TenantSectionComponent {
  ...
  roleClass(role: string): string {
    const map: Record<string, string> = {
      PRIMARY: "bg-primary",
      CO_TENANT: "bg-secondary",
      GUARANTOR: "bg-warning",
    };
