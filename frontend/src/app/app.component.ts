...
@Component({
  ...
  styles: [\`
    ...
    .app-header__brand h1 { margin: 0; font-size: 1.75rem; font-weight: 600; }
    .app-header__brand p { margin: 0.15rem 0 0 0; font-size: 0.85rem; opacity: 0.85; }
    ...
    .app-nav__link:hover { background: rgba(255,255,255,0.15); color: white; text-decoration: none; }
    .app-nav__link--active { background: rgba(255,255,255,0.2); color: white; }
    .app-nav__logout {
