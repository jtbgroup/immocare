...
export const CONFIG_KEYS = {
  ...
  ASSET_MAPPING_FIRE_EXTINGUISHER:  'asset.type.subcategory.mapping.FIRE_EXTINGUISHER',
...
export const CONFIG_LABELS: Record<string, string> = {
  ...
  // Phase 5
  'boiler.service.alert.threshold.months':          'Seuil alerte chaudière (mois avant expiration)',
  'asset.type.subcategory.mapping.BOILER':          'Sous-catégorie auto — Chaudière',
  'asset.type.subcategory.mapping.FIRE_EXTINGUISHER': 'Sous-catégorie auto — Extincteur',
